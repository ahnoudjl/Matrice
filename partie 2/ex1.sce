...
title("logarithme décimal du temps d’exécution en fonction du logarithme décimal de n")
subplot(1,2,2)
plot(log10(tab(1, :)), log10(tab(3, :)), "r+")
title("logarithme décimal de l’erreur en fonction du logarithme décimal de n")
